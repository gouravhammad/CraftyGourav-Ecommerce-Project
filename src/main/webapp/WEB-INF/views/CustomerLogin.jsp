...
<body>
  ...
  <div class="container">
      <br><br><br>
      <spring:form action="saveCustomerLogin" modelAttribute="customer" method="POST" enctype="multipart/form-data" class="text-center form-signin shadow-lg p-3 bg-white rounded">
          <img class="mb-4" src="<c:url value='images/logo.svg' />" alt="" width="72" height="72">
          <h1 class="h1 mb-3 font-weight-normal" style="font-family: 'Kaushan Script';">User Login</h1>
          ...
          <spring:input type="password" path="password" class="form-control mt-1 shadow bg-white rounded"  placeholder="@Password" />
          ...
          <div class="checkbox mb-3">
		    ...
		    <label>
		      <a href="customerSignup">Don't have an account ? Click here!</a>
		    </label>
		  </div>
