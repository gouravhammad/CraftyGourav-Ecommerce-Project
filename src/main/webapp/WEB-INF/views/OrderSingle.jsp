            ...
            <div class="cotainer my-form">
              <div class="row justify-content-center">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                           <spring:form action="placeOrderSingle" modelAttribute="order" name="my-form">
                                <div class="form-group row">
		                             <spring:input type="hidden" path="productId"/> 
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-md-6">
                                        <spring:input class="form-control" type="number" path="quantity" readonly="true"/>
                                        <span class="text-center small"><spring:errors path="quantity" /></span>
                                    </div>
                                </div>
                          ...
                          <div class="card-footer h2 text-center">
                              <div class="row">
                                  <div class="col col-2"></div>
                                  <div class="col col-8"><h6>Change Quantity : </h6></div>
                                  <div class="col col-2"></div>
                              </div>
                              <div class="row">
                                  <div class="col col-2"></div>
                                  <div class="col col-8">									  
								    <form action="changeQuantitySingle">
										  <div class="form-row">
										    <div class="col col-6">
										      <input type="number" class="form-control" name="quantity" value="${order.quantity}" min="1" max="25" />
