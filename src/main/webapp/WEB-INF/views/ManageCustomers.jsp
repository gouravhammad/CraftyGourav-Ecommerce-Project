...
<body>
  ...
  <div class="container">
     <div class="row">
        <div class="col">
            <br><br><br>
            <h1 class="h1 mb-3 font-weight-normal text-center" style="font-family: 'Kaushan Script';">Manage Customers</h1>
            <div class="table-responsive-xl  shadow-lg p-1 bg-white rounded">
	           <table class="table table-striped ">
				   <thead class="thead-dark">
				     <tr class="small text-center">
				        <th class="align-top" scope="col">CUSTOMER NAME</th>
						<th class="align-top" scope="col">CUSTOMER EMAIL</th>
						<th class="align-top" scope="col">CUSTOMER PASSWORD</th>
						<th class="align-top" scope="col">CUSTOMER NUMBER</th>
						<th class="align-top" scope="col">CUSTOMER CITY</th>
						<th class="align-top" scope="col">CUSTOMER STATE</th>
						<th class="align-top" scope="col">CUSTOMER ADDRESS</th>
						<th class="align-top" scope="col">CUSTOMER PICTURE</th>
					...
					<tbody>
						<c:forEach var="customer" items="${customers}">
							<tr class="small font-weight-bold text-center ">
								...
								<td class="align-middle">${customer.mobileNumber}</td>
								<td class="align-middle">${customer.city}</td>
								<td class="align-middle">${customer.state}</td>
								<td class="align-middle">${customer.address}</td>
								<td class="align-middle"><img src="LoadCustomerDP?email=${customer.email}" height="124" width="124" /></td>
								<td class="align-middle">[<a href="showRemoveCustomerConfirmation?delEmail=${customer.email}">X</a>]</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
