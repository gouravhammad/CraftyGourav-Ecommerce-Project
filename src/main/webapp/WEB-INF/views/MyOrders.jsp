					...
					<tbody>
						<c:forEach var="ordered" items="${orderedOrders}">
							<tr class="small font-weight-bold text-center ">
								<td><a href="productDetails?productId=${ordered.productId}">Product Details</a></td>
								...
								<td>[<a href="cancelOrderConfirmation?orderId=${ordered.orderId}"> X </a>]</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
	           ...
	           <table class="table table-striped">
				...
				<tbody>
					<c:forEach var="delivered" items="${deliveredOrders}">
						<tr class="small font-weight-bold text-center">
							<td><a href="productDetails?productId=${delivered.productId}">Product Details</a></td>
	           ...
	           <table class="table table-striped ">
				...
				<tbody>
					<c:forEach var="cancel" items="${canceledOrders}">
						<tr class="small font-weight-bold text-center ">
							<td><a href="productDetails?productId=${cancel.productId}">Product Details</a></td>
