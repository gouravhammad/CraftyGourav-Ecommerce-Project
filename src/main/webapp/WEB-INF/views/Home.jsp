...
<body>
  ...
  <div class="container">
      ...
      <h1 class="h1 mt-4 font-weight-normal text-center shadow-lg p-2 rounded bg-dark text-light" style="font-family: 'Kaushan Script';">Welcome to CRAFTY GOURAV</h1><br>
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-4">
          <a class="btn btn-lg btn-success btn-block font-weight-bold pt-4 pb-3" href="aboutHome">Contact Us</a>
        </div>
      </div>
