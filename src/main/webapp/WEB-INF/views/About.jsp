...
<body>
  ...
  <div class="container">
       <div class="row align-items-end">
		    ...
		    <div class="col col-8">
		       <br><br><br>
		      <h1 class="h1 mb-3 font-weight-normal text-center" style="font-family: 'Kaushan Script';">ABOUT</h1>
		        <br>
		       <p class="text-justify">This is an Handmade art and crafty website where users can buy their desired Handmade Art and Craft Products as per their need. This website is fully responsive so you must know that this website will look great on any device, whether it's a phone, tablet, or desktop the website will remain responsive!
             This website is user friendly. Simple navigation provided to all the users throughout the website.</p>
             <p class="h6 text-center text-white shadow-lg bg-dark rounded p-3"> Incase of any query, you can mail us on: <strong>gouravhammad477@gmail.com</strong></p>
		    </div>
		    <div class="col col-2">
		    </div>
  		</div>
