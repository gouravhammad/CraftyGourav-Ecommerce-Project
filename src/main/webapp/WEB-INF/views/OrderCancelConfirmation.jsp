  ...
  <div class="container">
     ...
     <div class="row">
        ...
        <div class="col col-8 text-center mt-4">
            <br><br><br><br>
            <h2 class="h2 mb-3 font-weight-normal text-center" style="font-family: 'Kaushan Script';">Are you sure want to Cancel Order?</h2>
        </div> 
        <div class="col col-2">
        </div> 
     </div>  
                  ...
                  <div class="card-footer bg-white border border-white shadow-lg p-3 bg-white rounded">
                      <div class="row">
                          <div class="col text-center">
                              <a href="cancelOrder?orderId=${orderId}" class="btn btn-success btn-block btn-lg">Yes</a>
                          </div>
                          <div class="col text-center">
                              <a href="viewMyOrders" class="btn btn-danger btn-block btn-lg">No</a>
                          </div>
                      </div>
                  </div>
                </div>
