...
<body>
  ...
  <div class="container">
      <br><br><br>
      <form action="checkOTPCustomer" class="text-center form-signin">
          <h1 class="h1 mb-3 font-weight-normal" style="font-family: 'Kaushan Script';">OTP Verification</h1>
          <p class="text-justify">An OTP Was sent to ${email} Enter that OTP to verify your Account!</p>
          ...
          <div class="checkbox mb-3">
             <br>
		    <label>
		      <a href="resendOTP">Didn't recieved OTP? Click to resend OTP</a>
		    </label>
		  </div>
