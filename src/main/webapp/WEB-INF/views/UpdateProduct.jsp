              ...
              <div class="row justify-content-center">
                    ...
                    <div class="card shadow-lg p-1 bg-white rounded">
                        <div class="card-header h2 text-center">
          					<h1 class="h1 mb-2 font-weight-normal" style="font-family: 'Kaushan Script';">Update Product</h1>
                        </div>
                        <div class="card-body">
                          <spring:form action="addProductChanges" modelAttribute="product" method="POST" enctype="multipart/form-data" name="my-form">
